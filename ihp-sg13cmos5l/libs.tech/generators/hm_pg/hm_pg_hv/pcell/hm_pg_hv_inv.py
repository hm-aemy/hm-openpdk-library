...
from ihp import PDK
from ihp.cells import guard_ring, nmos_hv, pmos_hv
...
def inverter(
    ...
    n = c.add_ref(nmos_hv(width=width_n, length=length, nf=1))
    p = c.add_ref(pmos_hv(width=width_p, length=length, nf=1))
