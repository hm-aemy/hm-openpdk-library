...
C {hm_stdcells/sg13cmos5l_LevelUp_noptap.sym} 250 -110 0 0 {name=x15}
C {hm_stdcells/sg13cmos5l_LevelUp_noptap.sym} 350 50 0 0 {name=x16}
...
C {hm_stdcells/sg13g2_io_tie_noptap.sym} 540 50 0 0 {name=x1}
...
C {hm_stdcells/hm_Tgate_noptap.sym} -100 -120 0 0 {name=x2}
C {hm_stdcells/hm_Tgate_noptap.sym} -100 40 0 0 {name=x3}
