...
N 140 -100 160 -100 {lab=pad}
N 140 -140 160 -140 {lab=pad}
N 150 -260 150 -220 {lab=iovdd}
N 50 -260 150 -260 {lab=iovdd}
N 140 -110 140 -100 {lab=pad}
N 130 -120 140 -130 {lab=pad}
N 140 -140 140 -130 {lab=pad}
N 140 -110 150 -120 {lab=pad}
...
N 130 -120 150 -120 {lab=pad}
N 200 -50 200 20 {lab=!}
N 180 20 200 20 {lab=!}
N 10 -190 10 -130 {lab=#net1}
N 10 -120 10 -40 {lab=#net2}
N 40 0 40 20 {lab=!}
N -140 20 40 20 {lab=!}
...
N 150 -120 230 -120 {lab=pad}
N 80 -120 130 -120 {lab=pad}
...
N -170 -130 10 -130 {lab=#net1}
N -170 -120 10 -120 {lab=#net2}
N 80 -120 80 -100 {lab=pad}
N -90 -100 -90 -40 {lab=pad}
N -90 -100 80 -100 {lab=pad}
...
N 80 -180 80 -120 {lab=pad}
N 80 -100 80 -50 {lab=pad}
...
C {iopin.sym} 230 -120 0 0 {name=p3 lab=pad
}
C {iopin.sym} -270 -110 0 1 {name=p4 lab=c2p_en
}
C {sg13g2_DCPDiode_noptap.sym} 150 -180 0 0 {name=x2}
C {sg13g2_DCNDiode.sym} 150 -60 0 0 {name=x1}
C {sg13g2_GateDecode_noptap.sym} -210 -120 0 0 {name=x3}
C {sg13g2_Clamp_N15N15D.sym} 50 -40 0 1 {name=x4}
C {sg13g2_Clamp_P15N15D_noptap.sym} 50 -190 0 1 {name=x5}
C {iopin.sym} -270 -130 0 1 {name=p5 lab=c2p
}
C {sg13g2_LevelDown_noptap.sym} -130 -40 0 1 {name=x6}
