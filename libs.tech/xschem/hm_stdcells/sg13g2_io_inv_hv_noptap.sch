...
E {}
N 0 0 0 40 {lab=out}
N 0 -110 0 -100 {lab=iovdd}
N 0 100 0 120 {lab=iovss}
N 120 70 120 90 {lab=sub}
N -60 0 -60 70 {lab=in}
N -80 0 -60 0 {lab=in}
N -60 -70 -60 0 {lab=in}
...
N 0 0 40 0 {lab=out}
N 0 -40 0 0 {lab=out}
N 0 -70 20 -70 {lab=iovdd}
N 20 -110 20 -70 {lab=iovdd}
N 0 -110 20 -110 {lab=iovdd}
N 0 -120 0 -110 {lab=iovdd}
N 0 70 120 70 {lab=sub}
...
C {iopin.sym} 120 90 0 0 {name=p5 lab=sub}
